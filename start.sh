...
for name in VARNISH_BACKEND_PORT VARNISH_BACKEND_HOST HOST_HEADER CONTENT_NOTIFICATIONS_PUSH_PORT LIST_NOTIFICATIONS_PUSH_PORT CONTENT_NOTIFICATIONS_PUSH_API_PORT
do
    eval value=\$$name
